...
<body>
	...
	<div class="card mb-4">
		<div class="card-header">
			<em class="fas fa-table me-1"></em> Leave Details
		</div>
	</div>
	<div class="card-body">
		...
		<caption></caption>
			<thead>
				<tr>
					<th id="slno">SL No</th>
					<th id="lvmType">Leave Name</th>
					<th id="lvmAbbr">Leave Abbrivation</th>
					<th id="edit">Edit</th>
			...
			<tbody>
				...
				<tr>
					<td><%=slno%></td>
					<td><%=lvm.getLvmName()%></td>
					<td><%=lvm.getLvmAbbr()%></td>
					<td><a href="editlvm?lvmId=<%=lvm.getLvmId()%>"
						class="btn btn-success btn-sm rounded-0" data-toggle="tooltip"
						data-placement="top" title="Edit"><em class="fa fa-edit"></em></a></td>

					<td><a href="deletelvm?lvmId=<%=lvm.getLvmId()%>"
