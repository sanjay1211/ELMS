                                    ...
                                    %>
                                        <form action="updateEmp" method="post">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                     <% if(emp.getUser().getRole().getRoleId()==3){ %>
                                                        <input type="radio" name="roleName" checked="checked" value="EMPLOYEE"
                                                            >Employee
                                                            <br> <input type="radio" name="roleName" value="MANAGER"
                                                           >Manager
                                                           <%}else{%>
                                                            <input type="radio" name="roleName"  value="EMPLOYEE"
                                                            >Employee
                                                            <br> <input type="radio" name="roleName" value="MANAGER" checked="checked"
                                                           >Manager
                                                           <%} %>
                                                    </div>
                                                </div>
